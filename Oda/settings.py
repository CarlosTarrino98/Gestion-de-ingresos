...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'finanzas.context_processors.saldo_actual',
            ],
        },
    },
]
...
LOGIN_URL = '/login/'              # Redirige al login si no está logueado
LOGIN_REDIRECT_URL = '/ingresos/'  # A dónde ir después de iniciar sesión
